...
from octoauth.domain.application.dao import ApplicationDAO
from octoauth.domain.application.schemas import ApplicationReadDTO, ApplicationWriteDTO
...
def search_applications():
    with Session as session:
        ...
        response_data = [
            ApplicationReadDTO.from_model(application) for application in applications
        ]
    return response_data
